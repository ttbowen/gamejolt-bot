...
class Bot extends dist_1.Client {
    ...
    _onUserEnter(roomId, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (user.id === 15071) {
                this.chat.sendMessage(`Your ruler and master **${user.displayName}** has entered the chat`, roomId);
            }
        });
    }
    _onUserMuted(userId, roomId, isGlobal, user) {
        return __awaiter(this, void 0, void 0, function* () {
            if (user)
                this.chat.sendMessage(`${user.displayName} got unmuted.`, roomId);
            if (user.id === this.clientUser.id)
                this.chat.sendMessage('Oh shit I got muted!', roomId);
        });
    }
}
__decorate([
    once('client-ready')
], Bot.prototype, "_onReady", null);
__decorate([
    on('message')
], Bot.prototype, "_onMessage", null);
__decorate([
    on('user-enter-room')
], Bot.prototype, "_onUserEnter", null);
__decorate([
    on('user-unmuted')
], Bot.prototype, "_onUserMuted", null);
